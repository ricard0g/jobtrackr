...
- [Running Locally](running-locally.md): human-focused commands for running frontend only, backend only, the backend container, the full app, DB resets, and Git workflow.
