...
- Rejected missing production PostgreSQL, JWT, CV Generation token, and R2 settings, including the documented example JWT signing key and PostgreSQL password
